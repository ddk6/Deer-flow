...
DFlow 是基于开源 DeerFlow 项目的独立二次开发项目。本仓库保留 DeerFlow 原项目的版权声明与 MIT License 许可声明。

ddk6 与 DFlow 贡献者新增或修改的代码、文档、skills、工作流设计及其它扩展内容，作为 DFlow 贡献进行维护；除非另有说明，这些 DFlow 贡献同样以 MIT License 发布。

任何再分发或继续修改都应保留 DeerFlow 原始声明、MIT License 以及本 DFlow 声明。
